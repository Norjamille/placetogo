<script setup>
    import StaticNavigations from '@/Components/Admin/StaticNavigations.vue';
import UserAccountDropdown from '@/Components/Admin/UserAccountDropdown.vue';
</script>
      ...
      -->
        ...
        -->
                    ...
                    <div class="flex items-center flex-shrink-0 px-4">
                        <img class="w-auto h-8" src="https://tailwindui.com/img/logos/mark.svg?color=purple&shade=500"
                            alt="Your Company">
                    </div>
